...
def test_switch_tab_to_filling(driver):
    ...
    assert driver.find_element(*locators.fillings_section).text == "Начинки"

def test_switch_tab_to_sause(driver):
    driver.get("https://stellarburgers.nomoreparties.site/")
    ...
    assert driver.find_element(*locators.sauces_section).text == "Соусы"

def test_switch_tab_to_buns(driver):
    driver.get("https://stellarburgers.nomoreparties.site/")
    ...
    assert driver.find_element(*locators.buns_section).text == "Булки"
